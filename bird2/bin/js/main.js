...
},{"./util":4,"eventemitter2":5}],2:[function(require,module,exports){
require("./init")
...
Bird = (function(_super) {
  ...
  Bird.prototype.updateY = function() {
    ...
    if (this.y >= HEIGHT - this.bird.height) {
      this.y = HEIGHT - this.bird.height;
      this.vy = 0;
      this.vx = 0;
      this.isDie = true;
    } else {
...
},{"./common.coffee":7,"eventemitter2":5}],7:[function(require,module,exports){
var AGENT, HEIGHT, RATE, WIDTH;
...
var $, AGENT, HEIGHT, RATE, WIDTH, debug, eDebug, util, _ref;
...
},{"../../lib/util":4,"./common.coffee":7}],9:[function(require,module,exports){
var Game, bird, birdDOM, debug, flipWhenTouchDown, game, loadImageAndDraw;
...
loadImageAndDraw = function() {
  ...
  birdDOM.addEventListener("load", function() {
    bird.init(birdDOM);
    flipWhenTouchDown();
    return game.add(bird);
  });
  birdDOM.src = "assets/bird.png";
  return document.body.appendChild(birdDOM);
};
...
},{"../../lib/game":2,"./bird.coffee":6,"./debug.coffee":8}]},{},[9]);