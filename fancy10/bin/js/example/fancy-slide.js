...
FancySlide = (function(_super) {
  ...
  FancySlide.prototype._initEvents = function() {
    ...
    gestureEvent.on("swipe up", (function(_this) {
      return function(dist, v) {
        ...
        if (dist > GAP || v > 1) {
          isRun = true;
          return _this.nextTimeline.progress(100);
        } else {
          return _this.nextTimeline.progress(0);
        }
      };
    })(this));
    ...
    return gestureEvent.on("swipe down", (function(_this) {
      return function(dist, v) {
        ...
        if (dist > GAP || v > 1) {
          isRun = true;
          return _this.prevTimeline.progress(100);
        } else {
          return _this.prevTimeline.progress(0);
        }
      };
    })(this));
  };
  ...
  FancySlide.prototype._enableAnimation = function() {
    ...
    if (this.prev) {
      this.prev.$container.addClass("transition");
    }
    if (this.next) {
      return this.next.$container.addClass("transition");
    }
  };
  ...
  FancySlide.prototype._disableAnimation = function() {
    ...
    if (this.prev) {
      this.prev.$container.removeClass("transition");
    }
    if (this.next) {
      return this.next.$container.removeClass("transition");
    }
  };
