...
FancySlide = (function(_super) {
  ...
  FancySlide.prototype._initEvents = function() {
    ...
    swiped = (function(_this) {
      return function(timeline, page, dist, v) {
        ...
        if (dist > GAP || v > 1) {
          ...
          duration = currentProgress * _this.duration;
          _this._enableAnimation(duration);
          timeline.progress(0);
        }
    ...
    gestureEvent.on("swipe up", (function(_this) {
      return function(dist, v) {
        return swiped(_this.nextTimeline, _this.next, dist, v);
      };
    })(this));
    ...
    return gestureEvent.on("swipe down", (function(_this) {
      return function(dist, v) {
        return swiped(_this.prevTimeline, _this.prev, dist, v);
      };
    })(this));
  };
  ...
  FancySlide.prototype._disableAnimation = function() {
    this.isAnimating = false;
    if (this.curr) {
      delete this.curr.$container[0].style.webkitTransition;
    }
    if (this.prev) {
      delete this.prev.$container[0].style.webkitTransition;
    }
    if (this.next) {
      return delete this.next.$container[0].style.webkitTransition;
    }
  };
