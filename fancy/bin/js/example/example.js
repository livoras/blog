...
var CURRENT_Z_INDEX, DURATION, FancySlide, GAP, HEIGHT, WIDTH, gestureEvent,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
FancySlide = (function(_super) {
  ...
  FancySlide.prototype.initStatus = function(prevState, currState, nextState) {
    var SCALE;
    SCALE = 0.6;
  ...
  FancySlide.prototype.showProcess = function() {};

  FancySlide.prototype.hideProcess = function() {};
  ...
  FancySlide.prototype._remakeTimelines = function() {
    ...
    if (this.next) {
      ...
      ntl.to(this.curr.$container, DURATION, this.prevState, "next").to(this.next.$container, DURATION, this.currState, "next").call((function(_this) {
        return function() {
    ...
    if (this.prev) {
      ...
      ptl.to(this.curr.$container, DURATION, this.nextState, "prev").to(this.prev.$container, DURATION, this.currState, "prev").call((function(_this) {
        return function() {
