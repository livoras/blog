...
var A_KEY, D_KEY, HEIGHT, J_KEY, MAN_SPRITE, STUPID_SPRITE, S_KEY, WIDTH, W_KEY, addBackground, create, direct, game, initGame, isJump, isTouchLeft, isTouchRight, jump, ledges, listenAndMakeManMove, makeButtons, makeLedge, makeMan, makePhysicsWorld, makeScore, makeStars, man, preload, render, runLeft, runRight, score, scoreText, stars, update, velocity, _ref;
...
makePhysicsWorld = function() {
  return game.physics.startSystem(Phaser.Physics.P2JS);
};
