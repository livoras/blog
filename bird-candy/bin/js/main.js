...
Bird = (function(_super) {
  ...
  Bird.prototype.draw = function() {
    return this.bird.style.webkitTransform = "translate3d(" + this.x + "px, " + this.y + "px, 0) rotateY(" + this.rotateY + "deg)";
  };
...
Candy = (function(_super) {
  ...
  Candy.prototype.moveToRandomPos = function() {
    var GAP, x, y;
    GAP = 40;
    x = this.bounds.left + GAP + (this.bounds.right - this.bounds.left - this.width - 2 * GAP) * Math.random();
...
var $, $area, $score, Game, HEIGHT, WIDTH, bird, boundBricks, bricks, candy, collideCandyAndBird, common, debug, flipWhenTouchDown, game, initArea, initBird, initBricks, initCandy, initStates, load, r, score, states, updateBricksCount, updateScore, util;
