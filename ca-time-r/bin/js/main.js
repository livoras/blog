...
var $, Game, HEIGHT, WIDTH, bird, ctx, dt, eCanvas, eDebug, game, loadImageAndDraw, man, test, userAgent, util, world;
...
man = {
  ...
  update: function() {
    ctx.clearRect(this.x, this.y, bird.width, bird.height);
  ...
  draw: function() {
    return ctx.drawImage(bird, this.x, this.y, bird.width, bird.height);
  }
};
