...
var $, $comments, $newCommentForm, $submitComment, clearForm, commentTpl, hbs, utils;
...
$submitComment.click(function(event) {
  ...
  return promise.error(function(error) {
    return alert('发送失败：' + error.responseJSON.error[0]);
  });
});


},{"../tpl/comment.hbs":20,"./utils.coffee":19,"handlebars":16,"jquery":17}],19:[function(require,module,exports){
var $, utils;
