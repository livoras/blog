...
var EasySlide, GAP, HEIGHT, MAX_GAP, WIDTH, css, gestureEvent, setY,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
EasySlide = (function(_super) {
    ...
    gestureEvent.on("swiping up", (function(_this) {
      return function(dist) {
        ...
        if (_this.currentIndex === _this.pages.length - 1) {
          ...
          if (dist > GAP) {
            _this._activeProgressByIndex(_this.currentIndex + 1);
          } else if (_this.currentActiveProgressIndex !== _this.currentIndex) {
            _this._activeProgressByIndex(_this.currentIndex);
          }
        }
  ...
  EasySlide.prototype._activeProgressByIndex = function(index) {
    this.currentActiveProgressIndex = index;
...
run = function() {
  ...
  core.setSlide(slide);
  core.start();
  return $("div.inner-content").append("" + window.screen.width + ", " + window.screen.height);
};
